...
const isFollowed = computed(() => {
    let res = $userStore.followings.find(following => following.followee_id === post.value.user.id)
    if (res) {
        return true
    }
    return false
